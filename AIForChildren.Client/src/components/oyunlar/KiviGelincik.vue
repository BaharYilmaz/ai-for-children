<template>
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div v-if="isLoading">
            <page-head icon="play-fill" title="Elma veya Kivi" />
            <!-- Secenekler -->
            ...
            <div class="container-fluid" v-if="isTrain">
                ...
                <div class="row justify-content-center">
                    <!-- Mutlu -->
                    <div class="card border-info mb-3 bg-dark col-md-2 ml-2 mr-2 mt-2" v-for="(renk, index) in kiwiorapple" :key="index">
                ...
                <div v-if="tekSonuc">
                    ...
                    <div v-if="tekSonuc" class="card border-info mb-3 bg-dark col-md-4 mx-auto" style="max-width: 18rem;">
                        ...
                        <div class="card-body text-warning">
                            ...
                            <img v-if="secim2Secildi" :src=resimler.testapple2 alt="testapple2" class="img-thumbnail">
                            <img v-if="secim3Secildi" :src=resimler.testCar alt="testCar" class="img-thumbnail">
                            <img v-if="secim4Secildi" :src=resimler.testkivi2 alt="testkivi2" class="img-thumbnail">
                        </div>
                    </div>
                    <div class="text-center" v-if="tekSonuc">
                        <h2 class="text-center bg-success" v-if="secim1Secildi">Kivi</h2>
                        <h2 class="text-center bg-success" v-if="secim2Secildi">Elma</h2>
                        <h2 class="text-center bg-success" v-if="secim3Secildi">Elma</h2>
                        <h2 class="text-center bg-success" v-if="secim4Secildi">Kivi</h2>
                        <fireworks></fireworks>
            ...
            <div class="container-fluid" v-if="isTest">
                ...
                <div v-if="isSecildiMi" class="text-center">
                    <div class="card border-info mb-3 bg-dark col-md-4 mx-auto" style="max-width: 18rem;">
                        <div class="card-header bg-transparent border-info text-center text-warning">Seçiminiz</div>
                        <div class="card-body text-warning">
                            <img v-if="secim1Secildi" :src=resimler.kivi1 alt="Kivi" class="img-thumbnail">
                            <img v-if="secim2Secildi" :src=resimler.apple1 alt="Elma" class="img-thumbnail">
                            <img v-if="secim3Secildi" :src=resimler.apple2 alt="Elma" class="img-thumbnail">
                            <img v-if="secim4Secildi" :src=resimler.kivi2 alt="Kivi" class="img-thumbnail">
                        </div>
                        <div class="card-footer bg-transparent border-info text-center">
    ...
    export default {
        ...
        data(){
            return{
                ...
                tumSonuclar: false,
                tekSonuc: false,
                kiwiorapple: [require("@/assets/img/oyunlar/kiwiorapple/1.jpg"),require("@/assets/img/oyunlar/kiwiorapple/17.jpg"),require("@/assets/img/oyunlar/kiwiorapple/3.jpg"),require("@/assets/img/oyunlar/kiwiorapple/11.jpg"),require("@/assets/img/oyunlar/kiwiorapple/6.jpg"),require("@/assets/img/oyunlar/kiwiorapple/7.jpg"),require("@/assets/img/oyunlar/kiwiorapple/20.jpg"),require("@/assets/img/oyunlar/kiwiorapple/8.jpg"),require("@/assets/img/oyunlar/kiwiorapple/19.jpg"),require("@/assets/img/oyunlar/kiwiorapple/2.jpg"),require("@/assets/img/oyunlar/kiwiorapple/9.jpg"),require("@/assets/img/oyunlar/kiwiorapple/10.jpg"),require("@/assets/img/oyunlar/kiwiorapple/12.jpg"),require("@/assets/img/oyunlar/kiwiorapple/13.jpg"),require("@/assets/img/oyunlar/kiwiorapple/14.jpg"),require("@/assets/img/oyunlar/kiwiorapple/4.jpg"),require("@/assets/img/oyunlar/kiwiorapple/15.jpg"),require("@/assets/img/oyunlar/kiwiorapple/5.jpg"),require("@/assets/img/oyunlar/kiwiorapple/16.jpg"),require("@/assets/img/oyunlar/kiwiorapple/18.jpg")],
                oyun:               {"id":4,"image": require('@/assets/img/oyunlar/kiviGelincik.jpg'),"zorluk": "Zorluk: Başlangıç","link":"/kiviveyagelincik","isim": "Kivi veya Elma","icerik": "Resimlerin kivi mi elma mı olduğunu bilgisayara öğretin. Daha sonra seçtiğiniz resmin hangisinin kivi hangisinin elma olduğunu tahmin edelim."},
                resimler:{"apple1":require("@/assets/img/oyunlar/kiwiorapple/apple/apple5.jpg"),"apple2":require("@/assets/img/oyunlar/kiwiorapple/apple/apple7.jpg"),"kivi1":require("@/assets/img/oyunlar/kiwiorapple/kiwi/kiwi3.jpg"),"kivi2":require("@/assets/img/oyunlar/kiwiorapple/kiwi/kiwi6.jpg"),"testCup":require("@/assets/img/oyunlar/kiwiorapple/kiviAll1.jpg"),"testkivi2":require("@/assets/img/oyunlar/kiwiorapple/kiviAll2.jpg"),"testCar":require("@/assets/img/oyunlar/kiwiorapple/appleAll1.jpg"),"testapple2":require("@/assets/img/oyunlar/kiwiorapple/appleAll2.jpg")},
            }
        },
        methods:{
            async basla(){
