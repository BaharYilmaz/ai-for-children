...
namespace AIForChildren.Models.Client
{
    public class AIReturn
    {
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public List<AIReturnError>
            Errors
        {
            get;
            set;
        } // Biz kullanıcıya mesaj döneceğimiz zaman birden fazla hata mesajı dönüyorsak bu kısma ekliyoruz.
    }
    
    public class AIReturnError
    {
        public string Message { get; set; }
